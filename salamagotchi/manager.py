...
class SalamagotchiManager:
    ...
    def get_help_text(self) -> str:
        return (
            ...
            "<b>Commands</b>\n"
            "<code>/salamagotchi_spawn &lt;name&gt;</code> - Spawn a new shared Salamagotchi\n"
            "<code>/salamagotchi</code> - Show its status, age, and today's needs\n"
            "<code>/feed</code> - Feed it (2 times per day)\n"
            "<code>/scoop</code> - Scoop poop (2 times per day)\n"
            "<code>/play</code> - Play with it (1 time per day)\n"
            "<code>/wash</code> - Wash it (1 time per day)\n\n"
            "<b>Rules</b>\n"
